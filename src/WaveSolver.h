...
class WaveSolver{
    public:
        ...
        void TimeRK4(double**& data, int size_t, int size_x, double space_step, double time_step);
        ...
        void Write(std::string filename, double**data, int size_t, int size_x, double space_step, double time_step);
